"""Task 1 – Learn the 8-bit memory task using Rule 110.

Train a linear SVM readout on *all* 256 possible 8-bit patterns fed through
a Rule-110 ECA reservoir, then evaluate recall on 100 random challenges and
...
OUT_DIR = pathlib.Path(__file__).resolve().parent / "task_1_artifacts"
...
out_path = OUT_DIR / "task_1_accuracy_histogram.png"
